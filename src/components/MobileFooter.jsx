            ...
            <div className="bg-white/90 dark:bg-gray-900/90 backdrop-blur-xl border border-white/20 dark:border-gray-800/50 rounded-full px-6 py-2 md:px-2 md:py-6 flex flex-row md:flex-col items-center gap-4 shadow-xl shadow-black/5">
                {navItems.map((item) => {
                    ...
                    return (
                        ...
                        >
                             <div 
                                className={`w-12 h-12 rounded-full flex items-center justify-center transition-all duration-300 ${active ? 'bg-black dark:bg-[#2E5A2E] shadow-lg shadow-black/20 dark:shadow-[#2E5A2E]/20 scale-110 md:scale-125 text-white' : 'hover:bg-gray-100 dark:hover:bg-gray-800'}`}
                            >
